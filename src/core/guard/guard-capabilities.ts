  ...
  return {
    ...
    cycle_compiler: {
      ...
      compact_model_contract: {
        ...
        accepted_anchor_restore: {
          supported: true,
          request_field: 'next_pass.restore_anchor_operation_id',
          model_supplies_undo_steps: false,
          exact_preview_sha_required: true,
          registered_state_parity: ['layer_order_visibility_opacity', 'active_layer', 'selection'],
    ...
    postcondition_verification: {
      ...
      current_checks: [
        ...
        'accepted-anchor restore requires exact registered preview SHA plus layer/active-layer/selection parity',
      ],
