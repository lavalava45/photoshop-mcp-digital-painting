...
- **Photoshop MCP** — 130 tools incl. 16 recipe workflows, digital-painting primitives, and measurement/landmarks/guides
...
- **Description:** `MCP server + local UI for AI-driven Photoshop automation. 130 tools, painting primitives, measurement/landmarks/guides, recipe workflows, cross-platform.`
